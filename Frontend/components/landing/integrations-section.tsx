...
const integrations = [
  { name: "OpenAI", category: "Gen AI" },
  { name: "Anthropic", category: "Gen AI" },
  { name: "Slack", category: "Reviews" },
  { name: "GitHub", category: "Assets" },
  { name: "Jira", category: "Projects" },
  { name: "AWS S3", category: "Storage" },
  { name: "Google Drive", category: "Library" },
  { name: "Salesforce", category: "Clients" },
  { name: "HubSpot", category: "Campaigns" },
    ...
    <section id="integrations" ref={sectionRef} className="relative overflow-hidden">
      ...
      <div className="relative z-10 pt-32 lg:pt-40 text-center">
        ...
        <p className={`mt-8 text-xl text-muted-foreground leading-relaxed max-w-lg mx-auto transition-all duration-1000 delay-100 ${
          ...
          Sync brand files, DAM libraries, and project tools. Designer pulls references in and pushes approved exports wherever your team already works.
        </p>
      </div>
      ...
      <div className={`relative left-1/2 -translate-x-1/2 w-screen -mt-16 transition-all duration-1000 delay-200 ${
        ...
        <img
          src="/images/marketing/connection.png"
          alt=""
          aria-hidden="true"
