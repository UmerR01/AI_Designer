...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      "Priority support",
      "Brand kits & shared libraries",
      "PSD, SVG & PDF handoff",
      "Review links & version history",
  ...
  {
    name: "Enterprise",
    description: "For global brands and platforms",
    ...
    features: [
      ...
      "Dedicated Designer success team",
    ],
    cta: "Contact sales",
    highlight: false,
  },
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-20">
          <div className="lg:col-span-7">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
              ...
              Simple
              <br />
              <span className="text-stroke">transparent pricing.</span>
            </h2>
          </div>
