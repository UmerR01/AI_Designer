...
const steps = [
  {
    ...
    description: "Drop in a product shot, paste a headline, or describe a mood. Designer reads intent, audience, and channel so the canvas starts in the right direction.",
    code: ``,
  },
  {
    number: "02",
    ...
    description: "Adjust layout, typography, and imagery with controls that respect layers and structure—so what you export still fits your review and handoff process.",
    code: ``,
  },
  {
    number: "03",
    title: "Export",
    subtitle: "& deliver",
    description: "Print-ready PDFs, web bundles, or motion-ready frames—plus share links and version locks when stakeholders need to sign off.",
    code: ``,
  },
];
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-white/30">Refine.</span>
              <span className="block text-white/10">Deliver.</span>
            </h2>
          </div>
