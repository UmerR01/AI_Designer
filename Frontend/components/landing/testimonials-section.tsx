...
const testimonials = [
  {
    quote: "Designer cut our social production cycle from days to hours—without sacrificing grid discipline or type quality. It feels like an extra senior on the team.",
    author: "Nina Okonkwo",
    role: "Creative Director",
    company: "North & Co.",
    metric: { value: "6×", label: "More campaign variants" },
  },
  {
    quote: "Clients share a mood board; we’re showing on-brand comps before the kickoff wraps. It changed how we pitch—and how fast we iterate.",
    author: "Julian Varga",
    role: "Partner",
    company: "Studio Relay",
    metric: { value: "40%", label: "Faster proposal cycles" },
  },
  {
    quote: "Localization used to break layouts. Designer reflows copy per market while our packaging rules stay intact—one sprint, twenty-eight locales.",
    author: "Amelia Hart",
    role: "Head of Brand Ops",
    company: "Lumen Foods",
    metric: { value: "28", label: "Locales shipped" },
  },
  {
    quote: "Audit trails and workspace isolation gave security and legal confidence—without slowing creative down.",
    author: "David Morales",
    role: "IT Security Lead",
    company: "Crescent Health",
    metric: { value: "0", label: "Open compliance issues" },
  },
];

/** Deterministic 0–1 value per grid cell so SSR and client markup match (no Math.random). */
function stableHash01(row: number, col: number): number {
        ...
        <div className="flex items-center justify-between mb-20">
          <div>
            ...
            <h2 className={`text-4xl lg:text-5xl font-display transition-all duration-1000 ${
              ...
              Trusted by teams
              <span className="text-background/40"> who ship creative.</span>
            </h2>
          </div>
