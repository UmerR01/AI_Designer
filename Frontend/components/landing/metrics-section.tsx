...
const metrics = [
  { 
    ...
    suffix: "", 
    prefix: "",
    label: "Assets generated today",
    sublabel: "across active studios worldwide",
  },
  { 
    value: 99, 
    suffix: ".99%", 
    ...
    sublabel: "including export pipeline",
  },
  { 
    value: 280, 
    suffix: "ms", 
    prefix: "<",
    label: "Median preview refresh",
    sublabel: "after an edit",
  },
];
    ...
    <section ref={sectionRef} className="relative py-32 lg:py-40 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className={`w-full mb-0 transition-all duration-1000 delay-200 ${
          ...
          <img
            src="/images/marketing/metrics-graph.png"
            alt=""
            aria-hidden="true"
        ...
        <div className={`mt-16 pt-8 border-t border-foreground/10 flex flex-wrap items-center gap-x-12 gap-y-4 text-sm font-mono text-muted-foreground transition-all duration-1000 delay-500 ${
          ...
          <span className="text-foreground">+40 creative integrations</span>
        </div>
      </div>
    </section>
  );
